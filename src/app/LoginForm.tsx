...
export default function LoginForm() {
  ...
  const handleRecoverPassword = (e: React.MouseEvent) => {
    e.preventDefault();
    setError('Para redefinir sua senha, entre em contato com o suporte em suporte@smartshop.com.');
  };
  ...
  return (
    <div className="login-view animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="login-form">
        ...
        <a href="#" className="login-recover-link" onClick={handleRecoverPassword}>
          Recuperar senha
        </a>

        {/* Botão Entrar (Pill verde) */}
        <Button
          type="submit"
        ...
        {/* Link Criar Conta Centrado no rodapé */}
        <div className="login-create-link-container">
          <Link href="/register" className="login-create-link">
            Criar conta
          </Link>
        </div>
      </form>
