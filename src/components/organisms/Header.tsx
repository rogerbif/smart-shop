...
import { Menu, LogOut, X, ListTodo, BarChart3, Package } from 'lucide-react';
    ...
    <>
      ...
      <div className={`sidebar-panel ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <Link href="/dashboard" className="sidebar-nav-item" onClick={() => setSidebarOpen(false)}>
            <ListTodo size={18} />
            <span>Minhas Listas</span>
          </Link>
          <Link href="/reports" className="sidebar-nav-item" onClick={() => setSidebarOpen(false)}>
            <BarChart3 size={18} />
            <span>Relatórios</span>
          </Link>
          <Link href="/pantry" className="sidebar-nav-item" onClick={() => setSidebarOpen(false)}>
            <Package size={18} />
            <span>Despensa</span>
          </Link>
